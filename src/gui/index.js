...
const material = new THREE.MeshPhongMaterial({color:materialColor.color,shininess:100,specular:0xffffff})
...
//gui
gui.add(ambient,'intensity',0,2).name('自然光').step(0.1)
gui.addColor(materialColor,'color').onChange(val=>{
